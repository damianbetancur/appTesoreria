 ...
 * @author Ariel
 */
public class PanelEmpresa extends javax.swing.JPanel implements InterfacePanel {

    private final ValidadorDeCampos validador;
    
    private final EmpresaController controlador;
    private final Empresa empresaAuxiliar;
    ...
    public PanelEmpresa() {
        ...
        this.controlador = new EmpresaController();
        this.empresaAuxiliar = controlador.getOrganismoInstanciaUnica();
        
        this.jtf_razonSocial.setText(empresaAuxiliar.getRazonSocial());
        this.jtf_direccion.setText(empresaAuxiliar.getDireccion());
        this.jtf_telefono.setText(empresaAuxiliar.getTelefono());
    }
